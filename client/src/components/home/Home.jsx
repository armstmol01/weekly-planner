      ...
      <div className="week__container">
        <div className='weekdays__container'>
          <section className='mon'>
            {mon===false?<IoIosAdd className='fixed__btn' onClick={() => {setMon(true)}}/>:<BsCheck className='fixed__btn' onClick={() => {setMon(false)}}/>}
            <p className='day-title'>Mon</p>
            <div className='spacing'><br></br></div>
            {mon===true?<div className='task new-task'>
              <div className='check__box'></div>
              <input className='task-input' spellCheck='false'></input>
            </div>:''}
            <div className='task'>
              <div className='check__box'></div>
